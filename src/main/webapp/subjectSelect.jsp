...
<%
     ...
     int no=0;
     try{
    	 String sql = "select b.idx, b.name, a.id, a.subject_name, a.credit, a.week, a. start_hour, a. end_hour from sub0904 a, lecturer0904 b where a.lecturer=b.idx order by b.idx";
